...
import '../../../../student/screens/leader_board.dart';

class KidsHomeParentScreen extends StatefulWidget {
  KidsHomeParentScreen({super.key, this.isParent = false, this.studnetId});
  static const String path = '/kids-home-screen-parent';
  bool? isParent;

  int? studnetId = 0;
  @override
  State<KidsHomeParentScreen> createState() => _KidsHomeParentScreenState();
}

class _KidsHomeParentScreenState extends State<KidsHomeParentScreen> {
  ...
  Widget build(BuildContext context) {
    log('app role is  ${AppConstants.loggedUser?.role} ');
    return Scaffold(
        body: Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          child: ListView(shrinkWrap: true, children: [
            FutureBuilder(
                future: IsParentLogedInDetails.isParentLogedIn()
                    ? AdmissionBloc()

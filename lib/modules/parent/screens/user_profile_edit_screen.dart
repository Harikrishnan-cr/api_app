...
class StudentprofileViewScrenn extends StatefulWidget {
  static const path = '/student-profile-view-screen';
  const StudentprofileViewScrenn({super.key});

  @override
  State<StudentprofileViewScrenn> createState() =>
      _StudentprofileViewScrennState();
}

class _StudentprofileViewScrennState extends State<StudentprofileViewScrenn> {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      //   onTap: (loader) async {
                      //     // loader();
                      //     controller.onEditProfileSubmited(loader: loader);
